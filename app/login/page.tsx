        ...
        <div className="w-full max-w-[400px]">
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            ...
            <div>
              ...
              <input value={password} onChange={(e) => setPassword(e.target.value)} type="password" required className="h-11 w-full rounded-lg border border-[#e5e6eb] bg-white px-4 text-sm text-[#1f2937] outline-none transition focus:border-[#0052d9] focus:shadow-[0_0_0_3px_rgba(0,82,217,0.1)]" placeholder="请输入密码" />
            </div>
